...
const founders = [
  {
    ...
    role: "Founder & CEO",
    photo: "/Mickaël.jpg",
    bio: "Hivin is the solution Mickaël was looking for, so he decided to build it. Driven by a desire to spark change, he sees Hivin as a global lever to accelerate creation in a world undergoing major transformations. His background combines sales expertise, recruitment, and technical team management, with one constant: building projects from the ground up.",
  ...
  },
  {
    ...
    photo: "/aun.jpg",
    bio: "Aun joins Hivin as Co-founder and Head of Technology, bringing a strong background in software development, AI and leadership. Both a hands-on builder and experienced manager, he is driven by the mission of connecting the right people with the right minds, making Hivin a catalyst for innovation.",
